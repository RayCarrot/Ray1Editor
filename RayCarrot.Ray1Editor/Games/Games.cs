...
namespace RayCarrot.Ray1Editor
{
    public static class Games
    {
        ...
        public static Game[] LoadedGames { get; } = new Game[]
        {
            ...
            new R1_Game("R1_PC_Demo_1", "Rayman 1 (PC - Demo 1)", () => new R1_PC_Demo1_GameManager(), GameModePathType.Directory, Ray1EngineVersion.PC, "r1_pc", Ray1PCVersion.PC_Demo_1),
            new R1_Game("R1_PC_Demo_2", "Rayman 1 (PC - Demo 2)", () => new R1_PC_Demo2_GameManager(), GameModePathType.Directory, Ray1EngineVersion.PC, "r1_pc", Ray1PCVersion.PC_Demo_2),
