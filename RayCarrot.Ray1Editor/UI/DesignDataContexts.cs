    ...
    public static class DesignDataContexts
    {
        public static EditorViewModel EditorViewModel
        {
            get
            {
                ...
                {
                    new LayerEditorViewModel(new TileMapLayer(new MapTile[4], Point.Zero, new Point(2, 2), new TileSet(null, new Point(16)))),
                    new LayerEditorViewModel(new TileMapLayer(new MapTile[8], Point.Zero, new Point(4, 2), new TileSet(null, new Point(16)))),
                });
