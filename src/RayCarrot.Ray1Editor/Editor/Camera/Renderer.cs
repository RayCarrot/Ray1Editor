...
namespace RayCarrot.Ray1Editor
{
    public class Renderer : IDisposable
    {
        ...
        public void Draw(Texture2D texture, Rectangle destinationRectangle, Color? color = null)
        {
            ...
            SpriteBatch.Draw(texture, destinationRectangle, color ?? Color.White);
        }
        public void Draw(Texture2D texture, Rectangle destinationRectangle, Rectangle? sourceRectangle, Color? color = null)
        {
            if (!Camera.IsInVisibleArea(destinationRectangle))
                return;

            SpriteBatch.Draw(texture, destinationRectangle, sourceRectangle, color ?? Color.White);
        }
        public void Draw(Texture2D texture, Rectangle destinationRectangle, Rectangle? sourceRectangle, float rotation, Vector2 origin, SpriteEffects effects, float layerDepth, Color? color = null)
        {
            if (!Camera.IsInVisibleArea(destinationRectangle))
                return;

            SpriteBatch.Draw(texture, destinationRectangle, sourceRectangle, color ?? Color.White, rotation, origin, effects, layerDepth);
        }
        ...
        public void DrawLine(Vector2 point, float length, float angle, Color color, float thickness)
        {
            ...
            SpriteBatch.Draw(_pixel,
                ...
                color,
                angle,
                new Vector2(0, (float)_pixel.Height / 2),
